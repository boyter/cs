...
// listItem represents one item in a CsList.
...
// CsList displays rows of items, each of which can be selected.
//
...
// NewCsList returns a new form.
func NewCsList() *CsList {
	return &CsList{
		Box:                     tview.NewBox(),
...
func (l *CsList) SetCurrentItem(index int) *CsList {
	if index < 0 {
...
func (l *CsList) GetCurrentItem() int {
...
func (l *CsList) RemoveItem(index int) *CsList {
	if len(l.items) == 0 {
		return l
	}
...
func (l *CsList) SetMainTextColor(color tcell.Color) *CsList {
	l.mainTextColor = color
	return l
}

// SetSecondaryTextColor sets the color of the items' secondary text.
func (l *CsList) SetSecondaryTextColor(color tcell.Color) *CsList {
	l.secondaryTextColor = color
	return l
}

// SetShortcutColor sets the color of the items' shortcut.
func (l *CsList) SetShortcutColor(color tcell.Color) *CsList {
	l.shortcutColor = color
	return l
}

// SetSelectedTextColor sets the text color of selected items.
func (l *CsList) SetSelectedTextColor(color tcell.Color) *CsList {
	l.selectedTextColor = color
	return l
}

// SetSelectedBackgroundColor sets the background color of selected items.
func (l *CsList) SetSelectedBackgroundColor(color tcell.Color) *CsList {
...
func (l *CsList) SetSelectedFocusOnly(focusOnly bool) *CsList {
...
func (l *CsList) SetHighlightFullLine(highlight bool) *CsList {
	l.highlightFullLine = highlight
	return l
}

// ShowSecondaryText determines whether or not to show secondary item texts.
func (l *CsList) ShowSecondaryText(show bool) *CsList {
...
func (l *CsList) SetWrapAround(wrapAround bool) *CsList {
...
func (l *CsList) SetChangedFunc(handler func(index int, mainText string, secondaryText string, shortcut rune)) *CsList {
	l.changed = handler
	return l
}
...
func (l *CsList) SetSelectedFunc(handler func(int, string, string, rune)) *CsList {
	l.selected = handler
	return l
}
...
// key.
func (l *CsList) SetDoneFunc(handler func()) *CsList {
	l.done = handler
	return l
}

// AddItem calls InsertItem() with an index of -1.
func (l *CsList) AddItem(mainText, secondaryText string, shortcut rune, selected func()) *CsList {
...
// selected.
func (l *CsList) InsertItem(index int, mainText, secondaryText string, shortcut rune, selected func()) *CsList {
	item := &listItem{
		MainText:      mainText,
...
func (l *CsList) GetItemCount() int {
	return len(l.items)
}

// GetItemText returns an item's texts (main and secondary). Panics if the index
// is out of range.
func (l *CsList) GetItemText(index int) (main, secondary string) {
	return l.items[index].MainText, l.items[index].SecondaryText
}

// SetItemText sets an item's main and secondary text. Panics if the index is
// out of range.
func (l *CsList) SetItemText(index int, main, secondary string) *CsList {
	item := l.items[index]
	item.MainText = main
...
func (l *CsList) FindItems(mainSearch, secondarySearch string, mustContainBoth, ignoreCase bool) (indices []int) {
...
func (l *CsList) Draw(screen tcell.Screen) {
	l.Box.Draw(screen)
...
func (l *CsList) InputHandler() func(event *tcell.EventKey, setFocus func(p tview.Primitive)) {
...
func (l *CsList) indexAtPoint(x, y int) int {
